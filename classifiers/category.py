"""Fashion category classification inference (EfficientNet-B3, 9 classes)."""
...
DEFAULT_CLASSES = [
    "Western RTW", "Ethnic RTW", "Other", "Streetwear",
    "Sarees", "Sportswear", "Intimates & Lounge",
    "Home Furnishing", "Beauty",
]
...
class CategoryInference:
    def __init__(self, checkpoint_path: str | Path, device: str = "cpu"):
        ...
        if not checkpoint_path.exists():
            raise FileNotFoundError(f"Category checkpoint not found: {checkpoint_path}")
        ...
        self.model = CategoryClassifier(num_classes=len(self.classes))
